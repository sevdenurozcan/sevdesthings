...
export default function Home() {
  ...
  return (
    ...
    <div>
        <div className="font-hd-font text-6xl font-light pt-2 pb-8 text-center text-hd-color bg-gradient-to-b from-hd-bg-color from-90% to-transparent sticky top-8 z-100 header" id="header">
        <h1> SEVDESTHINGS </h1>
        <h2 className="text-2xl pt-2 font-extralight"> Handmade Clothing </h2>
      </div>
      <div className='bg-base-color w-[150px] h-1.5 fixed z-150 rounded-l-xl right-0 top-[120px]'></div>
      <div className='bg-base-color w-[150px] h-1.5 fixed z-150 rounded-r-xl left-0 top-[70px]'></div>      
      ...
      <div className='flex flex-row justify-around gap-7 items-center text-xl font-extralight text-white m-10'>
        <div className='bg-hd-color w-[400px] h-[450px] p-10 rounded-md'>
          ...
          <Link href="/patterns"  className='bg-base-color w-[120px] h-[40px] relative left-[100px] top-[150px] rounded-md flex justify-center items-center text-hd-color font-light'>
            VISIT       
          </Link>
        </div>
        ...
        <div className='bg-hd-color w-[400px] h-[450px] p-10 rounded-md relative top-[60px]'>
          ...
          <Link href="/stores"  className='bg-base-color w-[120px] h-[40px] relative left-[100px] top-[150px] rounded-md flex justify-center items-center text-hd-color font-light'>
            VISIT       
          </Link>
        </div>
        ...
        <div className='bg-hd-color w-[400px] h-[450px] p-10 rounded-md  relative top-[120px]'>
          ...
          <Link href="/blog"  className='bg-base-color w-[120px] h-[40px] relative left-[100px] top-[150px] rounded-md flex justify-center items-center text-hd-color font-light'>
            VISIT       
          </Link>
        </div>

        </div>
        <div className="mt-64 mb-8 w-full h-[500px] overflow-hidden relative">
          <Image
            src="/yarns.jpg"
            alt="Bunch of yarns"
            fill
      ...
      <footer className='text-center text-hd-color font-extralight text-sm mb-1'>
        © 2025 SevdesThings. All rights reserved.
      </footer>
